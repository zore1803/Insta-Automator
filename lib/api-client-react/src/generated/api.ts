...
export const getGetTodaysPostsQueryKey = () => {
  return [`/api/posts/today`] as const;
};

export const getGetTodaysPostsQueryOptions = <
  TData = Awaited<ReturnType<typeof getTodaysPosts>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTodaysPosts>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTodaysPosts>>> = ({
    signal,
  }) => getTodaysPosts({ signal, ...requestOptions });
...
export type GetTodaysPostsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTodaysPosts>>
>;
...
export function useGetTodaysPosts<
  TData = Awaited<ReturnType<typeof getTodaysPosts>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const getRetryPostMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type RetryPostMutationResult = NonNullable<
  Awaited<ReturnType<typeof retryPost>>
>;
...
export const getExchangeTokenUrl = () => {
  return `/api/config/exchange-token`;
};
...
export const exchangeToken = async (
  ...
  return customFetch<TokenExchangeResult>(getExchangeTokenUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getMetaLoginUrl = () => {
  return `/api/config/meta-login`;
};

export const metaLogin = async (
  metaLoginBody: MetaLoginBody,
  options?: RequestInit,
): Promise<TokenExchangeResult> => {
  return customFetch<TokenExchangeResult>(getMetaLoginUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(metaLoginBody),
  });
};

export const getMetaLoginMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof metaLogin>>,
    TError,
    { data: BodyType<MetaLoginBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return metaLogin(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type MetaLoginMutationResult = NonNullable<
  Awaited<ReturnType<typeof metaLogin>>
>;
export type MetaLoginMutationBody = BodyType<MetaLoginBody>;
export type MetaLoginMutationError = ErrorType<unknown>;

/**
 * @summary Save Meta access token from Facebook JS SDK login
 */
export const useMetaLogin = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getMetaLoginMutationOptions(options));
};
